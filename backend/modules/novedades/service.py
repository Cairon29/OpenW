...
from backend.schemas import Novedad, CategoriaNovedad, SeveridadEnum, EstadoEnum
    ...
    def _analizar_con_ia(texto, categoria_detectada=None):
        ...
        try:
            ...
            if categoria_detectada:
                system_prompt += f"\nNota: el mensaje fue clasificado automáticamente como '{categoria_detectada.categoria}' por palabra clave."
