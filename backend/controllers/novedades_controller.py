...
@novedades_bp.route('/dashboard/metrics', methods=['GET'])
def dashboard_metrics():
    """Retorna métricas reales del dashboard calculadas desde la DB."""
    try:
...
@novedades_bp.route('/bot/metrics', methods=['GET'])
def bot_metrics():
    """Retorna métricas reales del bot desde conversaciones en memoria y la DB."""
    try:
